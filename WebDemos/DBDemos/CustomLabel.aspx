<%@ Reference Page="~/Chart.aspx" %>
<%@ Page language="c#" Inherits="WebDemos.DBDemos.CustomLabel" culture="en-US" uiCulture="en-US" CodeBehind="CustomLabel.aspx.cs" %>
...
<HTML>
	...
	<body vLink="#000080" aLink="#0000ff" link="#000080" leftMargin="0" topMargin="0" marginheight="0"
		...
		<form id="wfCustomLabel" method="post" runat="server">
			<tl:header id="stockHeader" runat="server"></tl:header><tl:demoheader id="stockDemoHeader" runat="server"></tl:demoheader><br>
			<table>
				<tr>
					<td><B>Symbol:</B>
