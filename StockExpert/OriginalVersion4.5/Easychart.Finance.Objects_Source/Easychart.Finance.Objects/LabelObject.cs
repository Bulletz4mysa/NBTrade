namespace Easychart.Finance.Objects
{
    ...
    public class LabelObject : BaseObject
    {
        ...
        private Easychart.Finance.Objects.StickAlignment stickAlignment;
        ...
        public PointF[] ToPoints()
        {
            ...
            if (base.CurrentGraphics != null)
            {
                ...
                if (this.StickHeight > 0)
                {
                    ...
                    {
                        case Easychart.Finance.Objects.StickAlignment.LeftTop:
                            offsetX = this.StickHeight;
                            offsetY = this.StickHeight;
                            break;

                        case Easychart.Finance.Objects.StickAlignment.LeftBottom:
                            offsetX = this.StickHeight;
                            offsetY = -this.Rect.Height - this.StickHeight;
                            index = 7;
                            break;

                        case Easychart.Finance.Objects.StickAlignment.RightTop:
                            offsetX = -this.Rect.Width - this.StickHeight;
                            offsetY = this.StickHeight;
                            index = 3;
                            break;

                        case Easychart.Finance.Objects.StickAlignment.RightBottom:
                            offsetX = -this.Rect.Width - this.StickHeight;
                            offsetY = -this.Rect.Height - this.StickHeight;
                            index = 5;
                            break;
        ...
        public Easychart.Finance.Objects.StickAlignment StickAlignment
        {
            get
            {
