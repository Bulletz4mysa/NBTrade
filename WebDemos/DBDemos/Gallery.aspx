...
<%@ Page language="c#" Inherits="WebDemos.DBDemos.Gallery" CodeBehind="Gallery.aspx.cs" %>
<HTML>
	<HEAD>
	...
	<body vLink="#000080" aLink="#0000ff" link="#000080" leftMargin="0" topMargin="0" marginwidth="0"
		...
		<form id="wfHelp" method="post" runat="server">
			...
			<table>
				<tr>
					<td><b>Gallery group:</b>&nbsp;&nbsp;<asp:dropdownlist id="ddlType" runat="server" AutoPostBack="True" onselectedindexchanged="ddlType_SelectedIndexChanged">
				...
				<tr>
					<td><asp:datalist id="dlGallery" runat="server" RepeatDirection="Horizontal" CellPadding="0" Width="700px"
						...
						<table>
							...
							<tr>
								<td><asp:button id="btnGo" runat="server" Text="Show Gallery" CssClass="ChartButton" onclick="btnGo_Click"></asp:button></td>
							</tr>
						</table>
					</td>
				</tr>
