...
namespace Easychart.Finance.Win
{
	...
	public class SelectFormula : Form	
	{
		...
		private void InitializeComponent()
		{
			...
			// tvFormula
			// 
			this.tvFormula.BorderStyle = BorderStyle.FixedSingle;
			this.tvFormula.Dock = DockStyle.Left;
			...
			this.tvFormula.AfterSelect += new TreeViewEventHandler(this.tvFormula_AfterSelect);
			// 
			// ilFormula
			// 
			this.ilFormula.ImageSize = new System.Drawing.Size(16, 16);
			this.ilFormula.ImageStream = ((ImageListStreamer)(resources.GetObject("ilFormula.ImageStream")));
			...
			// lbLines
			// 
			this.lbLines.Anchor = ((AnchorStyles)(((AnchorStyles.Top | AnchorStyles.Left) 
				| AnchorStyles.Right)));
			this.lbLines.BorderStyle = BorderStyle.FixedSingle;
			...
			// tbDesc
			// 
			this.tbDesc.Anchor = ((AnchorStyles)(((AnchorStyles.Top | AnchorStyles.Left) 
				| AnchorStyles.Right)));
			this.tbDesc.BackColor = System.Drawing.Color.Beige;
			this.tbDesc.BorderStyle = BorderStyle.FixedSingle;
			...
			// gbParam
			// 
			this.gbParam.Anchor = ((AnchorStyles)(((AnchorStyles.Top | AnchorStyles.Left) 
				| AnchorStyles.Right)));
