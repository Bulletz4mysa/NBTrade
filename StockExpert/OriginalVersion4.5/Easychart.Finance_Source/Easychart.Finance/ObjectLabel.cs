namespace Easychart.Finance
{
    ...
    public class ObjectLabel
    {
        ...
        public Easychart.Finance.StickAlignment StickAlignment;
        ...
        public void Draw(Graphics g)
        {
            ...
            if (this.StickHeight > 0)
            {
                ...
                {
                    case Easychart.Finance.StickAlignment.LeftTop:
                        offsetX = this.StickHeight;
                        offsetY = this.StickHeight;
                        break;

                    case Easychart.Finance.StickAlignment.LeftBottom:
                        offsetX = this.StickHeight;
                        offsetY = -layoutRectangle.Height - this.StickHeight;
                        index = 7;
                        break;

                    case Easychart.Finance.StickAlignment.RightTop:
                        offsetX = -layoutRectangle.Width - this.StickHeight;
                        offsetY = this.StickHeight;
                        index = 3;
                        break;

                    case Easychart.Finance.StickAlignment.RightBottom:
                        offsetX = -layoutRectangle.Width - this.StickHeight;
                        offsetY = -layoutRectangle.Height - this.StickHeight;
                        index = 5;
                        break;
