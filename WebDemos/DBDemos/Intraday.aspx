...
<%@ Page language="c#" Inherits="WebDemos.DBDemos.Intraday" CodeBehind="Intraday.aspx.cs" %>
<HTML>
	<HEAD>
	...
	<body vLink="#000080" aLink="#0000ff" link="#000080" leftMargin="0" topMargin="0" marginwidth="0"
		...
		<form id="wfIntraday" method="post" runat="server">
			...
			<asp:Button id="btnShowChart" runat="server" Text="Show Chart" onclick="btnShowChart_Click"></asp:Button>
			<br>
