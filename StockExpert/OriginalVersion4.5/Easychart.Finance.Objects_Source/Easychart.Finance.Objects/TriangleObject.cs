namespace Easychart.Finance.Objects
{
    ...
    {
        private Easychart.Finance.Objects.Shape shape;

        public override PointF[] CalcPoint()
        {
            if (this.shape == Easychart.Finance.Objects.Shape.ParralleloGram)
            {
        ...
        {
            this.shape = Easychart.Finance.Objects.Shape.ParralleloGram;
        }
        ...
        {
            this.shape = Easychart.Finance.Objects.Shape.Triangle;
        }
        ...
        public Easychart.Finance.Objects.Shape Shape
        {
            get
            {
                return this.shape;
