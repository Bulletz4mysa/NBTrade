...
namespace WebDemos
{
	...
	public class Config
	{
		...
		static public string CustomChartDataManager = Read("CustomChartDataManager","DB");
		static public string GalleryDataManager = Read("GalleryDataManager","DB");
		static public string DefaultDataManager = Read("DefaultDataManager","DB");
		static public string IntraDataManager = Read("IntraDataManager","Intra");
		
		static public string WebChartDataManager = Read("WebChartDataManager","Yahoo");
		...
		static public bool PrescanLoadToMemory = ReadBool("Prescan.LoadToMemory",true);
		...
		static public string PluginsDirectory 
		{
			get
			{
				...
				if (!s.EndsWith("\\"))
					s +="\\";
				return HttpRuntime.AppDomainAppPath+s;
			}
		}
