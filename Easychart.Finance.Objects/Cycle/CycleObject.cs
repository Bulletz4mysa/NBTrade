...
{
	public enum CycleStyle{Equal,FabonacciCycle,Sqr,Symmetry};
	...
	public class CycleObject: LineGroupTextObject
	{
		...
		{
			CycleStyle = CycleStyle.FabonacciCycle;
		}
		...
		public override ObjectInit[] RegObject()
		{
			return
				...
				new ObjectInit("Fabonacci cycle line",typeof(CycleObject),"FabonacciCycle","Cycle","CycleF"),
