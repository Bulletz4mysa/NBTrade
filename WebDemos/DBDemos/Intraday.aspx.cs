...
namespace WebDemos.DBDemos
{
	...
	public  partial class Intraday : System.Web.UI.Page
	{
		...
		private void BindChart()
		{
			...
			ExchangeIntraday ei = ExchangeIntraday.GetExchangeIntraday(Utils.GetExchange(Symbol));
			...
			imgChart.ImageUrl = "~/Chart.aspx?Provider="+Provider+"&Code="+ddlSymbols.SelectedItem.Value+
				...
				"&SV=0&BMargin="+BMargin+"&Fix="+(cbFixedTime.Checked?"1":"0"); 
		}
		...
		protected void btnShowChart_Click(object sender, System.EventArgs e)
		{
			BindChart();
		}
	}
