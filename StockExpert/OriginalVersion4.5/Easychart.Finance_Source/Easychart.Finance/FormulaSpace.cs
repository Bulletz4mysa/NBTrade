namespace Easychart.Finance
{
    ...
    public class FormulaSpace
    {
        ...
        public static CompilerResults Compile(string Code, string DestFileName, string ReferenceRoot)
        {
            ...
            options.ReferencedAssemblies.Add(ReferenceRoot + "Easychart.Finance.dll");
        ...
        {
            return ("using Easychart.Finance;\r\nusing Easychart.Finance.DataProvider;\r\n" + this.GetSource());
        }
        ...
        {
            new XmlSerializer(typeof(FormulaSpace)).Serialize(writer, this, new XmlSerializerNamespaces(new XmlQualifiedName[] { new XmlQualifiedName("Formula", "http://finance.easychart.net") }));
        }
