<%@ Register TagPrefix="tl" TagName="SelectFormula" src="~/Controls/SelectFormula.ascx" %>
...
<HTML>
	...
	<body vLink="#000080" aLink="#0000ff" link="#000080" leftMargin="0" topMargin="0" marginheight="0"
		...
		<form id="wfBackTesting" method="post" runat="server">
			<tl:header id="stockHeader" runat="server"></tl:header><tl:demoheader id="stockDemoHeader" runat="server"></tl:demoheader>
			<table width="800">
				<tr>
