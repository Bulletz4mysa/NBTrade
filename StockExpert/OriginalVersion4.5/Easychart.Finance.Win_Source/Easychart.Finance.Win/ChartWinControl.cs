namespace Easychart.Finance.Win
{
    ...
    public class ChartWinControl : UserControl, IObjectCanvas
    {
        ...
        private Easychart.Finance.ChartDragMode chartDragMode;
        ...
        public event Easychart.Finance.Win.BeforeApplySkin BeforeApplySkin;
        ...
        public ChartWinControl()
        {
            ...
            this.FavoriteFormulas = "VOLMA;EXTEND.RSI;CCI;OBV;ATR;FastSTO;SlowSTO;ROC;TRIX;WR;AD;CMF;PPO;StochRSI;ULT;BBWidth;PVO";
        ...
        private void ChartWinControl_MouseMove(object sender, MouseEventArgs e)
        {
            try
            {
                if (!this.Designing)
                {
                    int part = 3 - ((this.ChartDragMode == Easychart.Finance.ChartDragMode.Chart) ? 1 : 0);
                    ...
                    switch (hitInfo.HitType)
                    {
                        ...
                        case FormulaHitType.htAxisX:
                            {
                                if (!this.EnableXScale || (this.ChartDragMode == Easychart.Finance.ChartDragMode.None))
                                {
                                    goto Label_0361;
                                }
        ...
        private void ChartWinControl_Paint(object sender, PaintEventArgs e)
        {
            if (this.Chart != null)
            {
                ...
                this.Chart[0].Formulas[0].TextInvisible = false;
        ...
        public void SetDataCycle()
        {
            this.SetDataCycle(this.CurrentDataCycle);
        }

        public void SetDataCycle(string CycleString)
        {
