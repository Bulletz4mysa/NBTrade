namespace Easychart.Finance
{
    ...
    public class FormulaSkin
    {
        ...
        public Easychart.Finance.StockRenderType StockRenderType = Easychart.Finance.StockRenderType.Candle;
        ...
        public static FormulaSkin GreenRed
        {
            get
            {
                ...
                skin.AxisX.DateFormatProvider = DateTimeFormatInfo.InvariantInfo;
                skin.AllXFormats = XFormatCollection.Default;
                skin.BarPens = new Pen[] { Pens.Black, Pens.Black, Pens.Black };
        ...
        public static FormulaSkin PinkBlue
        {
            get
            {
                ...
                skin.StockRenderType = Easychart.Finance.StockRenderType.Bar;
                return skin;
            }
        }
