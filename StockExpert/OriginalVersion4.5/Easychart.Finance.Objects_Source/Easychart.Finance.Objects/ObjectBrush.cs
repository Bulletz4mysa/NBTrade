namespace Easychart.Finance.Objects
{
    ...
    {
        private int angle;
        private Easychart.Finance.Objects.BrushStyle brushStyle;
        ...
        public Brush GetBrush(RectangleF R)
        {
            ...
            {
                case Easychart.Finance.Objects.BrushStyle.Hatch:
                    return new HatchBrush(this.hatchStyle, this.Color, this.Color2);

                case Easychart.Finance.Objects.BrushStyle.Linear:
                    return new LinearGradientBrush(R, this.Color, this.Color2, (float) this.Angle, false);

                case Easychart.Finance.Objects.BrushStyle.Empty:
        ...
        public Easychart.Finance.Objects.BrushStyle BrushStyle
        {
            get
            {
