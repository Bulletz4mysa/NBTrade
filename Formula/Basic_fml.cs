...
namespace FML
{
	...
	public class BBI:FormulaBase
	{
		...
		public BBI():base()
		{
			AddParam("N1",3,1,100);
			AddParam("N2",6,1,100);
			AddParam("N3",12,1,100);
			AddParam("N4",24,1,100);
		}
	...
	public class DMA:FormulaBase
	{
		...
		public DMA():base()
		{
			AddParam("SHORT",10,2,300);
			AddParam("LONG",50,2,300);
			AddParam("M",10,1,300);
		}
	...
	public class EMA4:FormulaBase
	{
		...
		{
			AddParam("P1",5,1,300);
			AddParam("P2",10,1,300);
			AddParam("P3",20,1,300);
			AddParam("P4",60,1,300);
		}
	...
	public class MA4:FormulaBase
	{
		...
		{
			AddParam("P1",5,0,300);
			AddParam("P2",10,0,300);
			AddParam("P3",20,0,300);
			AddParam("P4",30,0,300);
		}
	...
	public class MACD:FormulaBase
	{
		...
		public MACD():base()
		{
			AddParam("LONG",26,20,100);
			AddParam("SHORT",12,5,40);
			AddParam("M",9,2,60);
		}
	...
	public class PPO:FormulaBase
	{
		...
		public PPO():base()
		{
			AddParam("LONG",26,5,100);
			AddParam("SHORT",12,2,40);
			AddParam("N",9,1,100);
		}
	...
	public class SAR:FormulaBase
	{
		...
		{
			AddParam("N",10,1,100);
			AddParam("STEP",2,1,100);
			AddParam("MAXP",20,5,100);
		}
	...
	public class BIAS:FormulaBase
	{
		...
		{
			AddParam("L1",6,1,300);
			AddParam("L2",12,1,300);
			AddParam("L3",24,1,300);
		}
...
SUM(IF(CLOSE<=LC,VOL,0),N)*100;
	...
	public class HV:FormulaBase
	{
		...
		public HV():base()
		{
			AddParam("N",21,1,10000);
			AddParam("T",252,0,1000000000);
		}
	...
	public class WVAD:FormulaBase
	{
		...
		public WVAD():base()
		{
			AddParam("N1",10,1,100);
			AddParam("N2",20,1,100);
		}
	...
	public class NVI:FormulaBase
	{
		...
		public NVI():base()
		{
			AddParam("Start",1,0,1000000000);
			AddParam("N1",9,0,10000);
			AddParam("N2",255,0,10000);
		}
	...
	public class Keltner:FormulaBase
	{
		...
		public Keltner():base()
		{
			AddParam("Length",16,1,100);
			AddParam("Factor",1.3,0,100);
		}
	...
	public class CHAIKIN:FormulaBase
	{
		...
		public CHAIKIN():base()
		{
			AddParam("LONG",10,5,300);
			AddParam("SHORT",3,1,300);
		}
	...
	public class MCO:FormulaBase
	{
		...
		public MCO():base()
		{
			AddParam("N1",19,10,80);
			AddParam("N2",39,30,100);
		}
	...
	public class VOSC:FormulaBase
	{
		...
		public VOSC():base()
		{
			AddParam("SHORT",12,2,50);
			AddParam("LONG",26,15,100);
		}
	...
	public class PVO:FormulaBase
	{
		...
		public PVO():base()
		{
			AddParam("N1",12,1,100);
			AddParam("N2",26,1,100);
			AddParam("N3",9,1,100);
		}
	...
	public class RCCD:FormulaBase
	{
		...
		{
			AddParam("N",59,1,100);
			AddParam("N1",21,1,100);
			AddParam("N2",28,1,100);
		}
	...
	public class ULT:FormulaBase
	{
		...
		{
			AddParam("N1",7,1,100);
			AddParam("N2",14,1,100);
			AddParam("N3",28,1,100);
		}
...
CLOSE-MAX(REF(CLOSE,1),HIGH),0)),0);
	...
	public class TimeLabel:FormulaBase
	{
		...
		{
			AddParam("D",20031231,0,100000000);
			AddParam("T",091000,0,100000000);
	...
	public class REF:FormulaBase
	{
		...
		public REF():base()
		{
			...
			AddParam("N",1,0,10000);
			AddParam("M",20,0,10000);
		}
