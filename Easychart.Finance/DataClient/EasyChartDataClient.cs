...
//
			return new string[]{"AMEX;Nasdaq;Nyse;^=All US & Index","AMEX;Nasdaq;Nyse=All US","AMEX","Nasdaq","Nyse","OTC+BB=OTC BB","Shanghai","Shenzhen","Toronto","Vancouver","ASX","^=Global Indices"};
		}
				...
				while (true) 
				{
					...
					if (OnStreamingData!=null)
					{
						DataPacket dp = new DataPacket(ss[0],
							...
							float.Parse(ss[2],NumberFormatInfo.InvariantInfo),
