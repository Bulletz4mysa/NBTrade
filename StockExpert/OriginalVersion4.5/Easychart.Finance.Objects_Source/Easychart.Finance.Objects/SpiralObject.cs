namespace Easychart.Finance.Objects
{
    ...
    public class SpiralObject : PolygonObject
    {
        ...
        private Easychart.Finance.Objects.SpiralType spiralType;
        private int sweepAngle = 0x708;

        public void Archimedes()
        {
            this.spiralType = Easychart.Finance.Objects.SpiralType.Archimedes;
        }
        ...
        public override PointF[] CalcPoint()
        {
            ...
            {
                case Easychart.Finance.Objects.SpiralType.Archimedes:
                    num6 = num3 / d;
                    break;

                case Easychart.Finance.Objects.SpiralType.Logarithmic:
                    num6 = num3 / Math.Exp(d);
                    break;

                case Easychart.Finance.Objects.SpiralType.Parabolic:
                    num6 = Math.Sqrt((num3 * num3) / d);
                    break;

                case Easychart.Finance.Objects.SpiralType.Hyperbolic:
                    num6 = num3 * d;
                    break;

                case Easychart.Finance.Objects.SpiralType.Lituus:
                    num6 = Math.Sqrt((num3 * num3) * d);
                    break;
            }
        ...
        {
            this.spiralType = Easychart.Finance.Objects.SpiralType.Hyperbolic;
        }

        public void Lituus()
        {
            this.spiralType = Easychart.Finance.Objects.SpiralType.Lituus;
        }

        public void Logarithmic()
        {
            this.spiralType = Easychart.Finance.Objects.SpiralType.Logarithmic;
        }

        public void Parabolic()
        {
            this.spiralType = Easychart.Finance.Objects.SpiralType.Parabolic;
        }
        ...
        public Easychart.Finance.Objects.SpiralType SpiralType
        {
            get
            {
