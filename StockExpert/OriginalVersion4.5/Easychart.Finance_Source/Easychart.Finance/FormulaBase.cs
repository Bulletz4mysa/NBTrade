...
namespace Easychart.Finance
{
    ...
    public class FormulaBase
    {
        ...
        {
            this.AddParam(ParamName, DefaultValue.ToString(), MinValue.ToString(), MaxValue.ToString(), "double");
        }

        public void AddParam(string ParamName, string DefaultValue, string MinValue, string MaxValue)
        {
            this.AddParam(ParamName, DefaultValue, MinValue, MaxValue, "string");
        }

        public void AddParam(string ParamName, string DefaultValue, string MinValue, string MaxValue, string ParamType)
        {
