namespace Easychart.Finance.Objects
{
    ...
    public class ImageObject : BaseObject
    {
        ...
        private Easychart.Finance.Objects.ImageType imageType = Easychart.Finance.Objects.ImageType.Resizable;
        ...
        public override void Draw(Graphics g)
        {
            ...
            if (this.B != null)
            {
                ...
                if (this.imageType == Easychart.Finance.Objects.ImageType.Rotate)
                {
        ...
        {
            this.ImageType = Easychart.Finance.Objects.ImageType.FixedSize;
        }
        ...
        private RectangleF GetDestRect(int w)
        {
            ...
            else if ((this.imageType == Easychart.Finance.Objects.ImageType.FixedSize) && (this.B != null))
            {
        ...
        {
            this.ImageType = Easychart.Finance.Objects.ImageType.Resizable;
        }

        public void RotateImage()
        {
            this.ImageType = Easychart.Finance.Objects.ImageType.Rotate;
        }
        ...
        public override int ControlPointNum
        {
            get
            {
                if (this.imageType == Easychart.Finance.Objects.ImageType.FixedSize)
                {
                    return 1;
                }
                if (this.imageType == Easychart.Finance.Objects.ImageType.Resizable)
                {
                    return 2;
                }
                return 3;
        ...
        public Easychart.Finance.Objects.ImageType ImageType
        {
            get
            {
