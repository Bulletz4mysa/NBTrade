...
<%@ Page language="c#" Inherits="WebDemos.QueryDB" enableViewState="False" CodeBehind="QueryDB.aspx.cs" %>
			...
			<table cellSpacing="1" cellPadding="4" width="680" bgColor="gray">
				<tr bgColor="whitesmoke">
					<td>
						...
						<asp:Button id="tnOK" runat="server" Text="OK" onclick="tnOK_Click"></asp:Button>
