		...
		public static DataPacket ParseEODData(string s) 
		{
			...
			try 
			{
				...
				DataPacket dp = new DataPacket(
					ss[0],
					DateTime.Parse(ss[1], DateTimeFormatInfo.InvariantInfo),// fp),
					double.Parse(ss[2],NumberFormatInfo.InvariantInfo),
					double.Parse(ss[3],NumberFormatInfo.InvariantInfo),
					double.Parse(ss[4],NumberFormatInfo.InvariantInfo),
					double.Parse(ss[5],NumberFormatInfo.InvariantInfo),
					double.Parse(ss[6],NumberFormatInfo.InvariantInfo) ,
					double.Parse(ss[5],NumberFormatInfo.InvariantInfo));
				return dp;
			}
			catch (Exception e)
