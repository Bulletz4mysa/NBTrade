...
<%@ Page language="c#" Inherits="WebDemos.Admin.TestServer" CodeBehind="TestServer.aspx.cs" %>
<HTML>
	<HEAD>
			...
			<table cellSpacing="1" cellPadding="4" bgColor="gray">
				<tr bgColor="whitesmoke">
					<td>
						...
						<asp:Button id="btnTest" runat="server" Text="Test" onclick="btnTest_Click"></asp:Button><br>
