namespace Easychart.Finance
{
    ...
    public class FormulaData
    {
        ...
        public Easychart.Finance.FormulaType FormulaType;
        ...
        public Easychart.Finance.Transform Transform;
        ...
        public void FillTo(ref double[] dd, int N)
        {
            if (dd.Length < N)
            {
                ...
                if ((this.FormulaType == Easychart.Finance.FormulaType.Const) && (numArray.Length > 0))
                {
                    naN = numArray[0];
                }
                dd = new double[N];
        ...
        public static implicit operator FormulaData(double N)
        {
            ...
            data.Data[0] = N;
            data.FormulaType = Easychart.Finance.FormulaType.Const;
            return data;
        }
        ...
        private void SetBrush(string s)
        {
            try
            {
                this.AreaBrush = new SolidBrush(ColorTranslator.FromHtml(s));
            }
            catch
            {
            }
