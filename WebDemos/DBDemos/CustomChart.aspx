...
<%@ Page language="c#" Inherits="WebDemos.DBDemos.CustomChart" CodeBehind="CustomChart.aspx.cs" %>
...
<HTML>
	...
	<body vLink="#000080" aLink="#0000ff" link="#000080" leftMargin="0" topMargin="0" marginheight="0"
		...
		<form id="wfCustomChart" method="post" runat="server">
			<asp:literal id="lScript" runat="server"></asp:literal><tl:header id="stockHeader" runat="server"></tl:header><tl:demoheader id="stockDemoHeader" runat="server"></tl:demoheader><br>
			<B>Stock Symbol:</B>
...
<br/>
			<asp:ImageButton id="ibChart" runat="server" ToolTip="Click on the chart to add a 'cross-hair' price indicator tool." onclick="ibChart_Click"></asp:ImageButton>
            <asp:Label id="lRedirect" runat="server"></asp:Label><br/>
			                                                         <B>Price Plot Attributes:</B><br/>
			<table>
				<tr>
					<td>
						<tl:SelectDateRange id="mySelectDateRange" runat="server"></tl:SelectDateRange>
			...
			<tl:footer id="stockFooter" runat="server"></tl:footer></form>
	</body>
</HTML>
