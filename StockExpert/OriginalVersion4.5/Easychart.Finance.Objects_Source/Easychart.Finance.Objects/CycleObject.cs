namespace Easychart.Finance.Objects
{
    ...
    public class CycleObject : LineGroupTextObject
    {
        ...
        private Easychart.Finance.Objects.CycleStyle cycleStyle;
        ...
        public override void CalcPoint()
        {
            ...
            for (int i = 0; ((x > 0f) && (x < rect.Right)) && (i < this.maxLines); i++)
            {
                ...
                {
                    case Easychart.Finance.Objects.CycleStyle.Equal:
                    {
                        this.CurrentCycle += num3;
                        continue;
                    }
                    case Easychart.Finance.Objects.CycleStyle.FabonacciCycle:
                    {
                        if ((i % 2) != 0)
                        {
                            break;
                    ...
                    case Easychart.Finance.Objects.CycleStyle.Sqr:
                    {
                        this.CurrentCycle = (i + 1) * (i + 1);
                        continue;
                    }
                    case Easychart.Finance.Objects.CycleStyle.Symmetry:
                    {
                        if (i != 0)
                        {
                            goto Label_018E;
        ...
        public void Equal()
        {
            this.CycleStyle = Easychart.Finance.Objects.CycleStyle.Equal;
        }

        public void FabonacciCycle()
        {
            this.CycleStyle = Easychart.Finance.Objects.CycleStyle.FabonacciCycle;
        }
        ...
        public void Sqr()
        {
            this.CycleStyle = Easychart.Finance.Objects.CycleStyle.Sqr;
        }

        public void Symmetry()
        {
            this.CycleStyle = Easychart.Finance.Objects.CycleStyle.Symmetry;
        }
        ...
        [ReadOnly(true)]
        public Easychart.Finance.Objects.CycleStyle CycleStyle
        {
            get
            {
        ...
        public override int InitNum
        {
            get
            {
                return (1 + (((this.cycleStyle == Easychart.Finance.Objects.CycleStyle.Equal) | (this.cycleStyle == Easychart.Finance.Objects.CycleStyle.Symmetry)) ? 1 : 0));
            }
        }
