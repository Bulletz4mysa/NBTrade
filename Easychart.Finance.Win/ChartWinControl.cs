...
namespace Easychart.Finance.Win
{
	...
	public class ChartWinControl : System.Windows.Forms.UserControl , IObjectCanvas
	{
		...
		private Easychart.Finance.Win.StatisticControl StatisticControl;
		...
		public bool ShowStatistic
		{
			get 
			{
				return StatisticControl.Visible;
			}
			set 
			{
				StatisticControl.Visible = value;
			}
		}
...
//					chart.StringsToArea(defaultFormulas.Split(';'));
		...
		private void InitializeComponent()
		{
			...
			this.StatisticControl = new Easychart.Finance.Win.StatisticControl();
			this.SuspendLayout();
			// 
			// cmRight
			// 
			...
			// StatisticControl
			// 
			this.StatisticControl.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.StatisticControl.BackColor = System.Drawing.SystemColors.Info;
			this.StatisticControl.Cursor = System.Windows.Forms.Cursors.Arrow;
			this.StatisticControl.ForeColor = System.Drawing.Color.Black;
			this.StatisticControl.Location = new System.Drawing.Point(-1000, 56);
			this.StatisticControl.Name = "StatisticControl";
			this.StatisticControl.Size = new System.Drawing.Size(192, 296);
			this.StatisticControl.TabIndex = 0;
			this.StatisticControl.Visible = false;
			// 
			// ChartWinControl
			// 
...
//						MouseZoomBmp = GetBitmap(false,true);
		...
		{
			if (StatisticControl.Visible)
			{
				if (StatisticControl.Left<0) 
					StatisticControl.Left = 10;
				...
				StatisticControl.RefreshData(sb.ToString());
		...
		{
			miStatistic.Checked = StatisticControl.Visible;
		}
...
//			}
		...
		{
			StatisticControl.Visible = !StatisticControl.Visible;
		}

		private void cmRight_Popup(object sender, System.EventArgs e)
		{
			miStatisticWindow.Checked = StatisticControl.Visible;
