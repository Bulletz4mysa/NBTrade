namespace Easychart.Finance
{
    ...
    public class FormulaChart
    {
        ...
        public FormulaChart()
        {
            ...
            this.LatestValueType = Easychart.Finance.LatestValueType.None;
            ...
            if (this.AllXFormats != null)
            {
                foreach (FormulaXFormat format in this.AllXFormats)
                {
                    if (Days100 < format.Days100Pixel)
                    {
                        ...
                        this.DataCycle = new Easychart.Finance.DataCycle(format.Interval.CycleBase, repeat);
        ...
        public void SetAxisXDataCycle(int Index, Easychart.Finance.DataCycle dc)
        {
            foreach (FormulaArea area in this.Areas)
            {
        ...
        public Easychart.Finance.AxisLabelAlign AxisLabelAlign
        {
            set
            {
                foreach (FormulaArea area in this.Areas)
        ...
        public Easychart.Finance.DataCycle DataCycle
        {
            set
            {
                foreach (FormulaArea area in this.Areas)
