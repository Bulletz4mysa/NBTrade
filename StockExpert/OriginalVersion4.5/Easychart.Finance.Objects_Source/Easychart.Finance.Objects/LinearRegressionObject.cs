namespace Easychart.Finance.Objects
{
    ...
    public class LinearRegressionObject : LineGroupObject
    {
        ...
        private Easychart.Finance.Objects.RegressionType regressionType;
        ...
        {
            this.regressionType = Easychart.Finance.Objects.RegressionType.AsynChannel;
        }

        public void InitChannel()
        {
            this.regressionType = Easychart.Finance.Objects.RegressionType.Channel;
        }

        public void InitDownTrend()
        {
            this.regressionType = Easychart.Finance.Objects.RegressionType.UpDownTrend;
            this.upLine = false;
        }
        ...
        {
            this.regressionType = Easychart.Finance.Objects.RegressionType.StdChannel;
        }

        public void InitStdErrorChannel()
        {
            this.regressionType = Easychart.Finance.Objects.RegressionType.StdErrorChannel;
        }
        ...
        public Easychart.Finance.Objects.RegressionType RegressionType
        {
            get
            {
